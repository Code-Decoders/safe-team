                        ...
                        members.map((member, index) => (
                            <div className={styles.transactionMemberTable} key={index}>
                                ...
                                <div style={{ width: '100px' }}>
                                    ...
                                    {member.status == 'Pending' && (member.email != user ?
                                        <Icon type='awaitingConfirmations' size='md' color='pending' /> : (
                                            <div style={{ display: 'flex', gap: '0 10px' }}>
                                                <div onClick={onTransactionApprove} style={{cursor: 'pointer'}}>
                                                    <Icon type='check' size='md' color='primary' />
                                                </div>
                                                <div onClick={onTransactionReject} style={{cursor: 'pointer'}}>
