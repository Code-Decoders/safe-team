  ...
  useEffect(() => {
    (async () => {
      ...
      const safeAuth = await SafeAuthKit.init(SafeAuthProviderType.Web3Auth, {
        chainId: "0x5",
        txServiceUrl: "https://safe-transaction-polygon.safe.global", // Optional. Only if want to retrieve related safes
        authProviderConfig: {
          rpcTarget: `https://matic-mumbai.infura.io/v3/${process.env.NEXT_PUBLIC_INFURA_PROJECT_ID}`,
